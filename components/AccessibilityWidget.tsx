...
const AccessibilityWidget = () => {
  ...
  useLayoutEffect(() => {
    ...
    const fallback = { x: window.innerWidth - buttonSize - 16, y: window.innerHeight - buttonSize - 16 };
    ...
    <>
      ...
      >
        <button
          ...
          className="bg-[#405862] hover:bg-[#334650] text-[#f1ece7] rounded-full w-12 h-12 flex items-center justify-center shadow-lg transition-all overflow-hidden"
          style={{ backgroundColor: '#405862' }}
        >
          <svg
            viewBox="0 0 256 256"
            fill="#f1ece7"
            className="w-7 h-7 block transition-all"
          >
